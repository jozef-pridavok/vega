// https://github.com/simolus3/goodies.dart/tree/main/shelf_multipart/lib
...
extension ReadMultipartRequest on Request {
  ...
  Stream<Multipart> get parts {
    ...
    return MimeMultipartTransformer(boundary).bind(read()).map((part) => Multipart(this, part));
  }
...
class Multipart extends MimeMultipart {
  ...
  Multipart(this._originalRequest, this._inner) : headers = CaseInsensitiveMap.from(_inner.headers);
