...
class MobileApi extends ApiServer2<Response> with MobileApiV1 {
  ...
  @override
  late final MobileApiConfig config;
  ...
  MobileApi(this.config) {
    ...
    log.print("Mobile API on ${config.host}:${config.port}");
