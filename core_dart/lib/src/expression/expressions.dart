...
abstract class Expression {
  ...
  static Expression parse(String formattedString) => _parser.expression.trim().end().parse(formattedString).value;
}
...
class BinaryExpression extends CompoundExpression {
  ...
  bool operator ==(Object other) =>
      other is BinaryExpression && other.left == left && other.operator == operator && other.right == right;
}
