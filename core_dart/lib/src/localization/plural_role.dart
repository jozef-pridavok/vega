// TODO: move me to core_dart and resuse in core_flutter
...
PluralCase _lv_rule() {
  if (_n % 10 == 0 || _n % 100 >= 11 && _n % 100 <= 19 || _v == 2 && _f % 100 >= 11 && _f % 100 <= 19) {
    return ZERO;
  }
  if (_n % 10 == 1 && _n % 100 != 11 || _v == 2 && _f % 10 == 1 && _f % 100 != 11 || _v != 2 && _f % 10 == 1) {
    return ONE;
  }
  return OTHER;
}
...
PluralCase _be_rule() {
  ...
  if (_n % 10 == 0 || _n % 10 >= 5 && _n % 10 <= 9 || _n % 100 >= 11 && _n % 100 <= 14) {
    return MANY;
  }
  return OTHER;
}
