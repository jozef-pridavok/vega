...
void vega(Environment environment) async {
  await VegaApp.ensureInitialized();
  ...
  ApiClient.configure(
    endPoint: F().apiUrl,
    apiKey: F().apiKey,
    //connectionTimeout: F().isDev ? const Duration(seconds: 30) : null,
    //timeout: F().isDev ? const Duration(seconds: 30) : null,
    dynamicHeaders: () {
    ...
    refreshAccessToken: () async {
      ...
      final remoteUserRepository = ApiUserRepository(deviceRepository: deviceRepository);
