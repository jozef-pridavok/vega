...
class SlotEventArranger<T extends Object?> extends EventArranger<T> {
  final int slotsCount;

  const SlotEventArranger({
  ...
  List<OrganizedCalendarEventData<T>> arrange({
    ...
    for (final event in mergedEvents) {
      ...
      while (concurrentEvents.isNotEmpty) {
        ...
        final end = event.endTime!.getTotalMinutes == 0 ? (24 * 60) : event.endTime!.getTotalMinutes;
