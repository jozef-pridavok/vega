...
void main() {
  ...
  group("[Parser]", () {
    ...
    test("it strips trailing comments", () {
      var out = psr.strip('needs="explanation"  # It was the year when they finally immanentized the Eschaton.');
      expect(out, equals('needs="explanation"'));
      out = psr.strip('needs="explanation  # It was the year when they finally immanentized the Eschaton." ');
    ...
    test("it handles quotes in a comment", () {
      ...
      var none = psr.parseOne('fruit =    banana  # comments can be "sneaky!" ');
    ...
    test("treats all # in unquoted as comments", () {
      var fail = psr.parseOne('fruit = banana # I\'m a comment with a final "quote"');
