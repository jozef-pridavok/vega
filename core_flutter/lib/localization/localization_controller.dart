import "package:core_dart/core_localization.dart";
import "package:flutter/material.dart";
import "package:intl/intl_standalone.dart" if (dart.library.html) "package:intl/intl_browser.dart";

import "localized_widget.dart";
...
class LocalizationController extends ChangeNotifier {
  ...
  LocalizationController({
    ...
    if (forceLocale != null) {
      ...
      LocalizedWidget.logger.debug(() => "Start locale loaded ${_locale.toString()}");
    }
    // If saved locale then get
    else if (saveLocale && _savedLocale != null) {
      LocalizedWidget.logger.debug(() => "Saved locale loaded ${_savedLocale.toString()}");
  ...
  Future<Map<String, dynamic>?> loadBaseLangTranslationData(Locale locale) async {
    try {
      ...
      LocalizedWidget.logger.warning(e.message);
    }
    return null;
  }
  ...
  Future<void> setLocale(Locale l) async {
    ...
    notifyListeners();
    LocalizedWidget.logger.debug(() => "Locale $locale changed");
  ...
  Future<void> resetLocale() async {
    LocalizedWidget.logger.debug(() => "Reset locale to platform locale $_deviceLocale");
