...
//   - https://github.com/Limbou/expandable_page_view

import "package:flutter/gestures.dart";
import "package:flutter/material.dart";

typedef ExpandablePageItemBuilder = Widget Function(BuildContext context, int index);

//@Deprecated("Use PageViewHeightAdaptable instead")
class ExpandablePageView extends StatefulWidget {
  ...
  const ExpandablePageView.builder({
    ...
    required ExpandablePageItemBuilder this.itemBuilder,
    this.controller,
    this.onPageChanged,
    this.reverse = false,
    this.animationDuration = const Duration(milliseconds: 100),
  ...
  @override
  createState() => _ExpandablePageViewState();
}
...
class _SizeReportingWidget extends StatefulWidget {
  ...
  @override
  createState() => _SizeReportingWidgetState();
}
